...
class _BudgetFormScreenState extends State<BudgetFormScreen> {
  ...
  void initState() {
    ...
    _subcategory = b?.subcategory;
    _country = b?.country ?? '';
    _plannedCtrl.text = b != null ? b.planned.toStringAsFixed(2) : '';
    _nature = b?.nature ?? TxNature.variable;
    _dueDate = b?.dueDate;
    _priority = b?.priority ?? Priority.media;
    _status = b?.status ?? TxStatus.pendiente;
